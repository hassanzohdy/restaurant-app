...
import { shopDropDownImg } from "shared/assets";
...
export default function ShopDropDown() {
  return (
    ...
    w-[900px] group-hover:py-[40px] group-hover:px-[60px] group-hover:h-[250px] transition-[height,_padding] group-focus-within:py-[40px] group-focus-within:px-[60px] group-focus-within:h-[250px]
    duration-500 ${isRTL() ? "top-[60px] -right-32" : "top-[60px] -left-32"}`}>
      ...
      <div className="relative w-[400px] h-[150px]  overflow-hidden rounded-xl">
        <img src={shopDropDownImg} alt="" className="h-full w-full" />
